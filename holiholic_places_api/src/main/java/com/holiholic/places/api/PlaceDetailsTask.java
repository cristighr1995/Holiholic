...
class PlaceDetailsTask implements Callable<Boolean> {
    ...
    public Boolean call() {
        ...
        try {
            ...
            places.put(index, buildPlaceInfo(placeId, placeCategory));
    ...
    private JSONObject buildHourObject(String time, int day) {
    ...
    private JSONObject formatHour(String time, int day) {
        try {
    ...
    private JSONObject buildDayObject(int day, String renderedTime) {
        try {
    ...
    private String mergeRenderedTime(JSONArray open) {
        if (open.length() == 1) {
    ...
    private JSONArray buildPlaceHours(JSONArray timeFrames) {
    ...
    private JSONObject buildPlaceInfo(String placeId, PlaceCategory placeCategory) {
